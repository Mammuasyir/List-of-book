...
function addBook() {
  ...
  const bookObject = makeBookObject(generateID, title, author, year, isComplete);
...
function newBook(bookObject) {
  ...
  if (bookObject.isComplete) {
    image.setAttribute('src', 'assets/images/finish.jpg');
  } else {
    image.setAttribute('src', 'assets/images/unfinish.jpg');
  }
